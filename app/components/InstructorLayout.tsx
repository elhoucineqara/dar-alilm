      ...
      <aside className={`fixed lg:fixed w-64 bg-gradient-to-b from-gray-900 via-gray-800 to-gray-900 border-r border-gray-700 h-screen overflow-y-auto z-50 transform transition-transform duration-300 ease-in-out ${
        ...
        <div className="p-5">
          ...
          <nav className="space-y-2">
            ...
            >
              <svg className={`w-5 h-5 ${pathname === '/instructor/dashboard' ? 'text-white' : 'text-gray-400 group-hover:text-white'}`} fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            >
              <svg className={`w-5 h-5 ${pathname.startsWith('/instructor/students') ? 'text-white' : 'text-gray-400 group-hover:text-white'}`} fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  ...
                  {showProfileDropdown && (
                    <div className="absolute right-0 mt-2 w-64 bg-white rounded-2xl shadow-2xl border border-gray-100 py-2 z-20 overflow-hidden" onClick={(e) => e.stopPropagation()}>
                      ...
                      <div className="py-2">
                        ...
                        <button
                          onClick={() => { setShowProfileDropdown(false); router.push('/instructor/settings'); }}
