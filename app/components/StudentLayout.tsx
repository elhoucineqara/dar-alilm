        ...
        <div className={`p-5 transition-all duration-300 ${sidebarOpen ? '' : 'px-3'}`}>
          ...
          <nav className="space-y-2">
            ...
            <Link
              ...
              title={!sidebarOpen ? 'Forum' : ''}
            >
              <svg className={`w-5 h-5 ${pathname === '/dashboard/forum' || pathname.startsWith('/dashboard/forum/') ? 'text-white' : 'text-gray-400 group-hover:text-white'}`} fill="none" stroke="currentColor" viewBox="0 0 24 24">
