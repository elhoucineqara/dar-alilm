...
export default function CreateForumPostPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      const token = localStorage.getItem('token');
      console.log('Sending request to /api/forum/posts');
      ...
      if (res.ok) {
        ...
        router.push(`/instructor/forum/${data.post._id}`);
      } else {
        const data = await res.json();
          ...
          <form onSubmit={handleSubmit} className="bg-white rounded-2xl shadow-xl p-6 sm:p-8 border border-gray-100">
            ...
            <div className="mb-6">
              ...
              <input
                ...
                placeholder="Ex: Important course update or announcement"
            ...
            <div className="mb-6">
              ...
              <textarea
                ...
                placeholder="Describe your announcement or discussion topic in detail..."
                rows={12}
