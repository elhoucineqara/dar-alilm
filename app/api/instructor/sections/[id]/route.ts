...
export async function PUT(
  ...
  try {
    ...
    const { title, description, type, order, fileId, fileUrl, fileName, fileType, youtubeUrl } = body;
    ...
    if (fileUrl !== undefined) updateData.fileUrl = fileUrl; // Keep for backward compatibility
